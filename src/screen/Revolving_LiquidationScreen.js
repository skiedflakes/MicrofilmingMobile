...
import RF_Liquidation_main from './RevolvingFund/Liquidation/RF_Liquidation_main';
import RF_Liquidation_upload from './RevolvingFund/Liquidation/RF_Liquidation_upload_main';
...
export default function PettyCash_ReplenishScreen({route}) {
  ...
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen
        name="Revolving Fund Liquidation Upload"
        component={RF_Liquidation_upload}
