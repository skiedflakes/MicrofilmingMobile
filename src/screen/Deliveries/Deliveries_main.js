...
export default function Deliveries_main ({navigation:{goBack},navigation,route}) {
  ...
  const get_images_data= (reference_number) =>{
    ...
    .then((responseJson) => {
      ...
      // trucking
      var data_trucking = responseJson.array_data_trucking.map(function(item,index) {
        return {
          url:item.slug,
        };
      });
  ...
  return (
    <View style={styles.main}>
      ...
      <Modal
        ...
        <View style={styles.centeredView}>
            ...
            <View style={styles.main_modalView}>
              ...
              <Text style={{flex:0.8,alignSelf:'center', textAlign:"center",fontWeight: "bold"}}>{selected_dr_number}</Text>
              </View>
              <View style={{flexDirection: 'row', padding:2,marginTop:20}} >
                ...
                <View style={{flexDirection: 'row', padding:2,marginTop:5}} >
                  <TouchableOpacity  onPress={() => { setImageView(img_list), image_found ? setmodal_img_Visible(true) : Alert.alert('No image Available') }} style={styles.rounded_btn}>
                    <View style={{ flexDirection: "row",}} >
              ...
              {trucking_status && 
                <View style={{flexDirection: 'row', padding:2,marginTop:20}} >
                <TouchableOpacity onPress={() => {setmodal_main_Visible(false); navigation.navigate('Upload Deliveries',{dr_number:selected_dr_number,user_id:user_id,chart_id:chart_id,trucking_status_string:trucking_status_string,selected_dr_id:selected_dr_id}); }} style={styles.rounded_btn}>
                  <View style={{ flexDirection: "row",}} >
                    <MCI  name="image-plus" size={20} color={"black"}/> 
                    <Text style={{flex:0.8,alignSelf:'center', textAlign:"center",}}>Trucking Add Image</Text>
                  </View>
                </TouchableOpacity>
               </View>
              }
              ...
              {trucking_status && 
                <View style={{flexDirection: 'row', padding:2,marginTop:5}} >
                <TouchableOpacity onPress={() => { setImageView(img_list_trucking), image_found_trucking? setmodal_img_Visible(true) : Alert.alert('No image Available') }} style={styles.rounded_btn}>
                  <View style={{ flexDirection: "row",}} >
                    <MaterialIcons  name="image-search" size={20} color={"black"}/> 
                    <Text style={{flex:0.8,alignSelf:'center', textAlign:"center",}}>Trucking View Image</Text>
                  </View>
                </TouchableOpacity>
               </View>
              }
      ...
      <Modal
        ...
        <ImageViewer imageUrls={imageViewList}
...
function RowItem ({navigation,delivery_number,dr_header_id,show_modal_main,get_images_data,tr_status,te_id}) {
  return (
